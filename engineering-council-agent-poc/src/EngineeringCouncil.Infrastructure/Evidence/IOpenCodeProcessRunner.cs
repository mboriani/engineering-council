...
/// <summary>
/// One invocation of the OpenCode executable, described without any shell string.
...
/// </summary>
public sealed record OpenCodeProcessRequest
{
...
/// <summary>
/// The bounded outcome of one OpenCode execution. On success, <see cref="StandardOutput"/>
...
/// </summary>
public sealed record OpenCodeProcessResult
{
...
/// <summary>
/// The minimal process-execution seam for the OpenCode agentic runtime (Milestone
/// 013.2). Its only job is to start the executable, set the working directory,
